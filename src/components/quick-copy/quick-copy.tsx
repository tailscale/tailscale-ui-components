    ...
    >
      ...
      {!hideAffordance && (
        <button
          ...
          className={cx("cursor-pointer text-blue-500 dark:text-blue-400", {
            "ml-2": children,
          })}
        >
          Copy
      ...
      {showButton && (
        <div
          ...
          ref={buttonRef}
        >
          <div className="flex border rounded-md border-border-interactive bg-bg-base">
            <div
              className={cx(
                "flex min-w-0 py-1 px-2 hover:bg-gray-0 dark:hover:bg-gray-800",
                {
            ...
            >
              ...
              <button
                className={cx(
                  "cursor-pointer text-blue-500 dark:text-blue-400",
                  {
                    "ml-2": children,
                  }
                )}
            ...
            {secondaryActionValue && (
              <div
                className="text-blue-500 dark:text-blue-400 py-1 px-2 border-l hover:bg-gray-100 dark:hover:bg-gray-800 rounded-r-md"
